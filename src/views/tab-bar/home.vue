  ...
  <div class="home-container">
    ...
    <div class="padding-bar" v-else>
      ...
      <div class="mx-12 -mt-40 text-left">
          ...
          <div class="flex items-center justify-between pt-20 pb-10 fb-w550">
            ...
            <router-link to="/">
              <div class="flex items-center justify-center">
                ...
                <img class="w-13 h-13 -mt-2" src="@/assets/images/icons/n-right.png" />
              </div>
            </router-link>
          </div>
        </Card>
        ...
        <router-link to="/">
          <img class="mt-10 w-full rounded-8" src="@/assets/images/banner.png" />
        </router-link>
        ...
        <Card class="mt-10 bar" title="热销商品对比" :is_bg="false" to="/price/compare">
          <img class="arrow-more" src="@/assets/images/icons/n-right.png" />
          <img class="icon w-13 h-13 title-icon" src="@/assets/images/icons/icon-goods.png" />
        </Card>
      </div>
    </div>
  </div>
